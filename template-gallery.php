        ...
        ?>
		  ...
		  <?php if ( $wp_query->max_num_pages > 1 ) : ?>
				<div class="colabs-pagination">
                    <div class="nav-previous"><?php previous_posts_link( __( '<span class="meta-nav">&larr;</span> Previous', 'colabthemes' ) ); ?></div>
                    <div class="nav-next"><?php next_posts_link( __( 'Next <span class="meta-nav">&rarr;</span>', 'colabthemes' ) ); ?></div>
				</div>
		  <?php endif; ?>
